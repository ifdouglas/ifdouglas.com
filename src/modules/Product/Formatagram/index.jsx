...
export default [
  {
    ...
    description: 'Coloque quantos espaços quiser, que nós garantimos que eles vão estar lá quando você postar.',
  },
  {
    image: <FormatagramSlide2SVG />,
    title: 'Leitura agradável',
    description: 'Sem pontos perdidos no seu texto, ler volta a ser algo natural e agradável. Seu público agradece.',
  },
  {
    image: <FormatagramSlide3SVG />,
    title: 'Aumente seu engajamento',
    description: 'O tempo que você perdia editando legenda, agora é convertido em mais tempo para engajamento do seu público.',
  }
]
